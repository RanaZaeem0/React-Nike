  ...
  return (
    ...
    <div
      ...
      <div className="pl-10 text-white flex max-sm:flex-col  pt-10 items-start justify-start ">
        ...
        <div className="pl-10 text-white leading-8">
          <h3 className="font-semibold">Help</h3>
          <div className="font-medium text-gray-500  text-sm leading-8  cursor-pointer zain">
          <h3>Get Help</h3>
          <h3>Order Status</h3>
        ...
        <div className="pl-10 text-white leading-8 cursor-pointer zain">
          <h3 className="font-semibold">Company</h3>
         <div className="font-medium text-gray-500   text-sm leading-8 ">
         <h3>About Nike</h3>
          <h3>News</h3>
          <h3>Careers</h3>
          <h3>Investor</h3>
        ...
        <div className="pl-10  leading-8 cursor-pointer zain">
